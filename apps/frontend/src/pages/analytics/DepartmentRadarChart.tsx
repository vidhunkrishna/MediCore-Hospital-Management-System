        ...
        >
          <ResponsiveContainer width="100%" height="100%">
            <RadarChart data={radarData} margin={{ top: 4, right: 24, bottom: 4, left: 24 }}>
              <PolarGrid stroke="hsl(222 47% 13%)" />
              <PolarAngleAxis dataKey="department" tick={{ fill: 'hsl(215 16% 47%)', fontSize: 10 }} />
              <PolarRadiusAxis tick={{ fill: 'hsl(215 16% 47%)', fontSize: 9 }} axisLine={false} />
