        ...
        {loading
          ...
          : alerts.map((alert, i) => (
            <motion.div
              ...
              className="flex items-start gap-3 p-3 rounded-xl bg-muted/40 border border-border hover:border-border/70 transition-colors group"
            >
              <div className={`w-2 h-2 rounded-full mt-1.5 flex-shrink-0 ${severityDot[alert.severity] ?? 'bg-muted-foreground'}`} />
