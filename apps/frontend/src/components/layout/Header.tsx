...
export function Header() {
  ...
  return (
    <motion.header
      ...
      className="fixed top-0 right-0 left-0 z-30 h-16 flex items-center gap-4 px-6 border-b border-border bg-background/80 backdrop-blur-xl"
    >
      ...
      <div className="hidden md:flex items-center gap-2 w-64">
        <div className="relative flex-1">
          ...
          <Input placeholder="Search..." className="pl-8 h-8 text-xs bg-secondary/50" />
        </div>
      </div>
